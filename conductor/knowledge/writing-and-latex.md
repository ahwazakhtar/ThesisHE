...
- The proposal (`Text/v2_Akhtar_Proposal.pdf`) has a **demand/supply structure**:
  ...
  decision** (memo drafted: `Text/committee_memo_ch3_structure.md`).
...
- Use the **`nber-economist-writing-style` skill** for any thesis prose. Reverse-engineered
  from `Text/w33491.pdf` (Aguilar-Gomez, Graff Zivin & Neidell 2025); annotated exemplars
...
- Three-essay abstracts + umbrella: `Text/thesis_paper_abstracts.md`.
- Technical note: `Text/technical_note_empirical_framework.{tex,html}` (§2.5.4 WCB note,
  §2.5.5 BEA pre-trends, §6 mechanisms).
- Mechanism documents: `Text/reviewer_response_mechanisms_nber.md` (+ `_email.md`),
  `Text/mechanisms_section.md` (§6), verdict in `Analysis/mechanism/mechanism_verdict.md`.
- Premium mediation write-up: `Text/premium_mediation_writeup.md`.
