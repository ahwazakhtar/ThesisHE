...
- [~] **Track: Code-Quality Remediation — Reproducibility Before Freeze** (operationalizes `Plans/coding_and_analysis_audit_20260712.md`: truthful test runner, RA source-panel rebuild, manual-CS quarantine + the −$1,050→null e=0 claim correction, bad-control sensitivity, post-dedup exhibit registry; acceptance = the audit's §7 minimum defense gate. Gates the manuscript freeze, not drafting. Created Jul 2026)
