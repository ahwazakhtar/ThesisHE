...
| E1-T3 Main DiD estimates | §6 Main result | `Analysis/did/did_2x2_drought_2012.csv` | `run_did_analysis.R` | 4.2.2 | county master | **y** (identical) | PCPI_Real ATT **−$1,310.67** — byte-identical pre/post dedup (Δ=0). |
