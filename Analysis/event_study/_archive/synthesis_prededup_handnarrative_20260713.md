> **[ARCHIVED / SUPERSEDED 2026-07-13 — do not cite. Coding audit A4 + A6.]**
> This is the **pre-dedup, hand-annotated** event-study synthesis. The live, script-generated
> file is `Analysis/event_study/synthesis.md` (regenerated on the certified 118,732×82 master).
> Two specific claims below are **retired**:
> - **"Key Finding 8" drought e=0 = −$1,050 (p=0.002)** used the manual Callaway–Sant'Anna
>   aggregation whose independence-based SEs are invalid (audit A4). The authoritative frontier
>   estimator (`did::att_gt`, DR; `Analysis/did/robustness/dr_csdid_eventtime.csv`) gives
>   **e=0 = −$324 (SE 276): null** — the 2012 income effect is event-specific even at onset.
> - The **"2012 Midwest drought"** label is a misnomer (Row 3, `Plans/master_evidence_table.md`):
>   the extreme-PDSI first-onset cohort is **Georgia + Mountain West + Plains**, not the Midwest.
