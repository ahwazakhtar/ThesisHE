...
| `advisor_robustness/` | Aug-2026 advisor items: spatial spillovers (1.1); clustering justification, window/horizon, MAD scaling to follow | **Spillovers amplify, not confound**: own+neighbor total exceeds own-only baseline for income/employment (joint p≈0.006); own-vs-neighbor split unidentified (r≈0.95) | `spillover_synthesis.md` |
