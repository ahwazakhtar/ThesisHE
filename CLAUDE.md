...
- **`hospital_supply_side_20260615` — registered, NOT yet implemented (next session).** Restores the proposal's Chapter 2 (supply side): weaves hospital finances through the three papers at the **hospital-year** level. Phase 1 = build the panel from NASHP HCT. Scope in its `spec.md`.
